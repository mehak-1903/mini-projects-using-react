...
function PostCard({post}) {
  return (
    <div className="bg-gray-900 p-6 rounded-lg group shadow-md text-white max-w-md mx-auto mb-6">
      <div className="bg-slate-700 p-9 rounded-xl transition duration-300 hover:scale-102 hover:shadow-2xl cursor-pointer">
